...
public class ImageStub extends ViewGroup {
    ...
    public ImageStub(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mLayoutId = sysTyped.getInt(0, mLayoutId);
            mLayoutWidth = (int) sysTyped.getDimension(0, mLayoutWidth);
            mLayoutHeight = (int) sysTyped.getDimension(2, mLayoutHeight);
            mBackgroundRef = sysTyped.getInt(3, mLayoutId);
            sysTyped.recycle();
        }
